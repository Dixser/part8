  ...
  Mutation: {
    addBook: async (root, args) => {
      ...
      if (!author) {
        ...
        try {
          ...
          throw new GraphQLError("There was an error saving the author", { invalidArgs: args })
        }
      }
      ...
      try {
        ...
        throw new GraphQLError("There was an error saving the book", { invalidArgs: args })
      }
      return book
    },
    ...
    createUser: async (root, args) => {
      ...
      try {
        ...
        throw new GraphQLError("There was an error saving the user", { invalidArgs: args })
      }
      return user
    },
    login: async (root, args) => {
      ...
      if (!user || args.password !== "secret") {
        throw new GraphQLError("Invalid credentials", { code: 'BAD_USER_INPUT' })
      }
      const userForToken = {
